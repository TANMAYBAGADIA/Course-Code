...
function buildComplete(){
	let levelName = document.getElementById("levelNameBox").value.trim() || "New Influxion Level";
	let songName = document.getElementById("songNameBox").value.trim() || "Good Song";
	let userName = document.getElementById("userNameBox").value.trim() || "Anonymous";
	let artistName = document.getElementById("artistNameBox").value.trim() || "Anonymous";
...
let songInput = document.getElementById('get-song');
let backgroundInput = document.getElementById("get-background");
...
songInput.onchange = ()=>{
	let songName = songInput.value.toLowerCase().replace("c:\\fakepath\\", "");
...
backgroundInput.onchange = ()=>{
	let color = backgroundInput.value.toLowerCase();
